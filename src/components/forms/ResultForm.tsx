  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <div className="flex justify-between flex-wrap gap-4">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          <select
            ...
            {...register("examId")}
            defaultValue={
              typeof data?.examId !== "undefined" && data?.examId !== null
                ? String(data.examId)
                : ""
            }
          >
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          <select
            ...
            defaultValue={
              typeof data?.assignmentId !== "undefined" && data?.assignmentId !== null
      ...
      <span className="text-xs text-gray-500">
        Linking an exam or assignment is optional—you can leave both blank for manual
        entries.
      </span>
